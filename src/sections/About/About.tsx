    ...
    <section className="py-5 md:py-10 w-full">
      <div className="container">
        ...
        <p className="text-xs md:text-sm xl:text-base mb-2">
          ...
          Матеріали, які потрібні для що конкретного виду робіт, зібрано в
          одному місці. Вам не потрібно &quot;бігати&quot; по різних сторінках в
        ...
        <p className="text-accent md:text-lg xl:text-xl font-bold text-center mb-2">
          БудСток — зручно, швидко, а головне по оптовим цінам зі складу!
        </p>
      </div>
    </section>
  );
